...
const h2k = (number) => {
    var SI_POSTFIXES = ["", " Thousand", " Million", " Billion", " Trillion", " P", " E"]
...
let d = new Date
let locale = 'id'
let gmt = new Date(0).getTime() - new Date('1 January 2022').getTime()
let weton = ['ꜱᴜɴᴅᴀʏ','ᴍᴏɴᴅᴀʏ', 'ᴛᴜᴇꜱᴅᴀʏ','ᴡᴇᴅɴᴇꜱᴅᴀʏ','ᴛʜᴜʀꜱᴅᴀʏ','ꜰʀɪᴅᴀʏ','ꜱᴀᴛᴜʀᴅᴀʏ'][Math.floor(((d * 1) + gmt) / 84600000) % 5]
